/// TODO: this file needed to be temporarily copied from the rodio crate to patch
/// a bug in get_duration_per_sample. it probably would be better to fork the rodio
/// crate and submit a PR
